...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto px-10 py-10">
        <div class="text-center mb-10">
            <h1 class="text-3xl font-bold mt-10 mb-5">📚 Selamat Datang Kembali di SIMPENKU!</h1>
    ...
    <?php endforeach; ?>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6 rounded-xl-custom shadow">
                    ...
                    <p class="text-sm mb-1">Kamu telah meminjam <strong><?= mysqli_num_rows($queryPeminjaman) ?></strong> buku</p>
                ...
                <div class="bg-white p-6 rounded-xl-custom shadow">
                    ...
                    <form action="../includes/proses_pinjam.php" method="POST" class="space-y-8">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_pinjam" required class="w-full border border-gray-300 rounded px-3 py-2">
                        </div>
                        <div>
                            <label class="block mb-3 font-medium text-sm">Tanggal Kembali</label>
                            <input type="date" name="tanggal_kembali" required class="w-full border border-gray-300 rounded px-3 py-2">
                        </div>
                        <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition">Pinjam Buku</button>
                    </form>
                </div>
            </div>
        </div>
