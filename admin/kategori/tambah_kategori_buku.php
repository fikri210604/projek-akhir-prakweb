...
if (isset($_POST['simpan'])) {
    ...
    if (move_uploaded_file($tmp, $upload_path)) {
        $query = "INSERT INTO kategori (nama_kategori, deskripsi, foto) VALUES ('$nama_kategori', '$deskripsi', '$nama_baru')";
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="file" id="foto_kategori" name="foto_kategori" class="form-control" accept="image/*" required>
                    </div>
                </div>
            </div>
